...
public class Options {
  ...
  public Options() throws IOException, JSONException {
    ...
    //Get server options
    File fserver = FileUtils.toFile(Options.class.getResource("/cz/inovatika/vdk/server_config.json"));
    ...
    if (f.exists() && f.canRead()) {
      ...
      if(JSONObject.getNames(customClientConf) != null){
...
//      }
      ...
      if(JSONObject.getNames(customServerConf) != null){
...
//      }
  ...
  public boolean getBoolean(String key) {
    return server_conf.optBoolean(key, false);
  }
